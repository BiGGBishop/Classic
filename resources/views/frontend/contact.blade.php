<x-master-layout>
				...
				<div class="pbmit-title-bar-content-inner">
					<div class="pbmit-tbar">
						<div class="pbmit-tbar-inner container">
							<h1 class="pbmit-tbar-title" style="color: wheat"> Contact Us</h1>
						</div>
					</div>
					<div class="pbmit-breadcrumb">
						<div class="pbmit-breadcrumb-inner">
							...
							<span><span class="post-root post post-post current-item" style="color: wheat"> Contact Us</span></span>
						</div>
					</div>
				</div>
			</div> 
	...
	<!-- Title Bar End-->
		...
		<div class="page-content">  
								...
								<div class="pbmit-ihbox-headingicon">
									<div class="pbmit-ihbox-wrap">
										<div class="pbmit-ihbox-contents">
											...
											<div class="pbmit-heading-desc">info@classicwhitestone.com.ng <br> book@classicwhitestone.com.ng</div>
										</div>
									...
									<div class="pbmit-btn-wrap">
										<div class="pbmit-ihbox-btn">
											<a href="mailto:nfo@classicwhitestone.com.ng">
								...
								<div class="pbmit-ihbox-headingicon">
									<div class="pbmit-ihbox-wrap">
										<div class="pbmit-ihbox-contents">
											...
											<div class="pbmit-heading-desc">112 Agor palace way okota, <br>Lagos, Nigeria</div>
										</div>
										{{-- <div class="pbmit-ihbox-icon">
											<div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
												<i class="pbmit-xclean-icon pbmit-xclean-icon-email"></i>
									...
									<div class="pbmit-btn-wrap">
										<div class="pbmit-ihbox-btn">
											<a href="https://www.google.com/maps/@6.5027786,3.3053692,3a,75y,307.31h,97.31t/data=!3m7!1e1!3m5!1sjnC1eE1QtwuIaVYRJuic3w!2e0!6shttps:%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fcb_client%3Dmaps_sv.tactile%26w%3D900%26h%3D600%26pitch%3D-7.313086679812713%26panoid%3DjnC1eE1QtwuIaVYRJuic3w%26yaw%3D307.30895299254024!7i16384!8i8192?entry=ttu&g_ep=EgoyMDI1MDEyMC4wIKXMDSoASAFQAw%3D%3D">
												<span class="pbmit-button-text">Read More</span>
												<span class="pbmit-button-icon-wrapper">
													<span class="pbmit-button-icon">
														<i class="pbmit-base-icon-black-arrow-1"></i>
			...
			<!-- Contact Form -->
			<section class="section-lgb contact-us-bg">
				<div class="container">
					<div class="row g-0">
						<div class="col-md-12 col-xl-5">
							<div class="pbmit-heading-subheading animation-style2">
								...
								<div class="pbmit-heading-desc">
									We carefully screen all of our workers, so you can rest assured that <br> your home would receive the absolute highest quality of service <br> providing. 
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-12 col-xl-6 pt-xl-0 pt-4">
									<a class="pbmit-btn pbmit-btn-outline" href="tel:+2348033842462">
						...
						<div class="col-md-12 col-xl-7">
							<div class="contact-form-rightbox">
								<form class="contact-form" method="post" id="contact-form" action="https://xclean-demo.pbminfotech.com/html-demo/send-dummy.php">
									<div class="row">
										<div class="col-md-6">
