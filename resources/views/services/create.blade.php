<x-app-layout>
    <div class="container mx-auto p-6 max-w-full bg-white">
        <h1 class="text-2xl font-bold mb-4 text-center">Create a New Service</h1>
        <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="text-center">
                <button type="submit" class="bg-blue-500 text-black px-4 py-2 rounded-lg hover:bg-blue-600 transition">Save Service</button>
            </div>
        </form>
    </div>
</x-app-layout>